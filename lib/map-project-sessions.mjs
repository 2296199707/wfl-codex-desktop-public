...
export class MapProjectSessionStore {
  ...
  async open(input = {}) {
    ...
    const inspected = projectFilePath
      ...
      session = {
        ...
        identity,
        gameProjectId: normalizeGameProjectId(input.gameProjectId),
        projectPath,
  ...
  context(input = {}) {
    ...
    return Object.freeze({
      ...
      gameProjectId: session.gameProjectId,
...
function normalizeGameProjectId(value) {
  ...
  if (!/^[A-Za-z0-9][A-Za-z0-9_-]{7,127}$/u.test(text)) {
    throw projectError(400, "invalid-game-project-id", "游戏工程 ID 无效");
  }
  return text;
}
