export class TurnStartDeduplicator {
  ...
  async resolve(
    ...
    // state is a fresh, non-uncertain submission or an unmaterialized shell.
    // Keep the read as the default because it is the duplicate-delivery
    // safeguard for retries whose outcome is unknown.
