...
export const CODEX_RUNTIME_BUNDLE_PACKAGE_ASSETS = Object.freeze([
  ...
  "test/fixtures/codex-app-server-0.153.4-client-methods.json",
  "test/fixtures/codex-app-server-0.153.4-notifications.json",
  "test/fixtures/codex-app-server-0.153.4-schema-manifest.json",
  "test/fixtures/codex-app-server-0.153.4-server-methods.json",
]);
...
export const MAP_EDITOR_PACKAGE_ASSETS = Object.freeze([
  ...
  "lib/map-conversation-binding-store.mjs",
  "lib/game-project-workspace-create.mjs",
  "lib/game-project-workspace-store.mjs",
  ...
  "public/map-editor/map-ai-focus-context.js",
