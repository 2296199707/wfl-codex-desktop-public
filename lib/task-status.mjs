    ...
    if (status === "offline") {
      for (const [key, state] of [...this.states]) {
        ...
        if (state.clientSubmissionId) {
          // A client-submitted Turn may already have reached Codex when the
          // bridge disappears. Keep it recoverable until native state proves
          // whether the submission was accepted; only synthetic/external
          // tasks without a client ID can be declared failed immediately.
