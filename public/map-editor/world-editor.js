...
import { parseTiledDocument } from "./tiled-document.js?v=0.44.72-beta";
import { decodeTiledTileData } from "./tiled-tile-codec.js?v=0.44.72-beta";
import {
  mapPixelBounds,
...
import {
  ...
  worldMapAtPoint,
  worldMapReference,
} from "./tiled-world.js?v=0.44.72-beta";
import {
  collectWorldMapNavigation,
  planWorldMapPreviews,
  validateWorldPortalReferences,
} from "./tiled-world-navigation.js?v=0.44.72-beta";
