    ...
    () async {
      ...
      final WindowsInitializationSettings initializationSettingsWindows =
          WindowsInitializationSettings(
            appName: 'WFL Codex Sync',
            appUserModelId: 'WFL.Codex.Sync',
  ...
  Widget build(BuildContext context) {
                  ...
                  when connection.isAutoSync:
                {
                  ...
                  try {
                    ...
                    await ref
                        ...
                        .uniSync(connection)
                        .toList();
                    logger.i('Successfully uploaded for ADD | MODIFY');
                  } catch (e, st) {
                    await notifService.show(
                      id: 23326,
                  ...
                  when connection.isDeletionEnabled && connection.isAutoSync:
                {
                  ...
                  try {
                    await ref
                        ...
                        .uniSync(connection)
                        .toList();
                    logger.i('Successfully uploaded for DELETE');
                  } catch (e, st) {
                    // TODO:
                    GeneralError('', e, st).logError();
                  }
    ...
    ref.listen<AsyncValue>(syncControllerProvider, (prev, state) {
      if (!state.isLoading && state.hasError) {
        context.showErrorSnackBar(l10n.syncFailed);
      }
    });

    return Scaffold(
      floatingActionButton: FloatingActionButton(
        tooltip: l10n.createConnectionTooltip,
        onPressed: () async {
          if (folders.length < 2) {
            context.showErrorSnackBar(l10n.needTwoFolders);
            return;
          }
