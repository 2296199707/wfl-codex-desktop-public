...
sealed class DriveProvider with _$DriveProvider {
  ...
  String get displayName => switch (this) {
    ...
    MinioProvider() => 'Minio',
    // Keep the upstream NextCloud model/serialization for compatibility, but
    // expose the WebDAV endpoint as the WFL Codex server in this fork.
    NextCloudProvider() => 'WFL Codex',
    LocalProvider() => 'Local',
  };
