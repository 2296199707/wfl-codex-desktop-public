      ...
      children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      switch (providersMap[folder.id]!.toNullable()!) {
                        ...
                        RemoteProviderModel(:final provider) => SizedBox(
                          width: 24,
                          child: SvgPicture.asset(provider.providerIcon),
                        ),
                      },
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            content.match(
              () => context.showErrorSnackBar(l10n.missingConnectionFields),
              (t) async {
