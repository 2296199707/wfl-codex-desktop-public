...
Current release: `v0.44.65`. See [CHANGELOG.md](CHANGELOG.md) for release notes.
...
sudo tar -xzf wfl-codex-desktop-v0.44.65.tar.gz -C /srv
sudo mv /srv/wfl-codex-desktop-v0.44.65 /srv/wfl-codex-desktop
cd /srv/wfl-codex-desktop
sudo bash install.sh
```
