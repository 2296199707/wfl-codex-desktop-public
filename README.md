...
Current release: `v0.44.80-beta`. See [CHANGELOG.md](CHANGELOG.md) for release notes.
...
sudo tar -xzf wfl-codex-desktop-v0.44.80-beta.tar.gz -C /srv
sudo mv /srv/wfl-codex-desktop-v0.44.80-beta /srv/wfl-codex-desktop
cd /srv/wfl-codex-desktop
sudo bash install.sh
```
