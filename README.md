...
Current release: `v0.45.0`. See [CHANGELOG.md](CHANGELOG.md) for release notes.
...
sudo tar -xzf wfl-codex-desktop-v0.45.0.tar.gz -C /srv
sudo mv /srv/wfl-codex-desktop-v0.45.0 /srv/wfl-codex-desktop
cd /srv/wfl-codex-desktop
sudo bash install.sh
```
